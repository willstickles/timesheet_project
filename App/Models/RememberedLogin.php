...
{
	/**
	 * Find a remembereed login model by the token
	 *
	...
	/**
	 * See if the remember token has expired or not, based on teh current system time
	 *
	 * @return boolean True if the token has expired, false othewise
	 */
